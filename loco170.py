...
def getOrm_AT_x(self):
    ...
    for j in range(len(self.indexes_correctors)):
        ...
        dict2 = { 's_pos': s_pos_c, 'closed_orbitx': closed_orbitx_c, 'closed_orbity': closed_orbity_c,
                'element_type':elements_type_c}
...
def getOrm_AT_y(self):
    ...
    for j in range(len(self.indexes_correctors)):
       ...
       # while (i < len(self.indexes_correctors)):
        ...
        dict2 = {'s_pos': s_pos_c,'closed_orbitx': closed_orbitx_c, 'closed_orbity': closed_orbity_c, 'elements_type': elements_type_c}
