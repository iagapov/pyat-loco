...
def getOrm_AT_x(self):
    ...
    for j in range(len(self.indexes_correctors)):
        ...
        fh2 = open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_Kick" + str(j) + ".csv", 'w', newline='')
        ...
        dict2 = {'KickAngle': elements_Strength_c, 'closed_orbitx': closed_orbitx_c, 'closed_orbity': closed_orbity_c,
                 's_pos': s_pos_c, 'element_type':elements_type_c}
...
def getOrm_AT_y(self):
    ...
    for j in range(len(self.indexes_correctors)):
       ...
       # while (i < len(self.indexes_correctors)):
        ...
        dict2 = {'KickAngle': elements_Strength_c, 'closed_orbitx': closed_orbitx_c, 'closed_orbity': closed_orbity_c, 's_pos': s_pos_c, 'elements_type': elements_type_c}
