...
def getOrm_AT_x(self):
    ...
    for j in range(len(self.indexes)):
        ...
        for l in range(len(self.indexes)):
            with open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_" + str(l) + ".csv", 'wt') as csvfile:
                ...
                #df.to_csv("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_" + str(i[0]) + str(i[1]) + ".csv")
                #df.to_csv("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_" + str(l) + ".csv")
                    print(str1)
