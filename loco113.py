...
def getOrm_AT_x(self):
    ...
    for j in range(len(self.indexes)):
        ...
        for i in range(len(self.indexes)):
            ...
            fh = open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_x/orm_x_CXY_" + str(i)+ ".csv", 'w',  newline='')
            ...
            for k in self.indexes:
                    ...
                    str2 = closed_orbitx
                    str3 = closed_orbity
                    fh = open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_" + str(i) + ".csv",
