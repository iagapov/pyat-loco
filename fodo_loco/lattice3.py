...
#SF = elements.Sextupole('SF', 0.01, 0.0)
...
ring_old = [B1H, CXY01, DD, BPM, QF,SF, DD, B1H, B1H, CXY02, DD, BPM, QD, DD, B1H,
...
ring_ = [B1H, CXY01, DD, BPM, QF, DD, B1H, B1H, CXY02, DD, BPM, QD, DD, B1H, m0]


ring_no_sd_qs = [B1H, CXY01, DD, BPM, QF, DD, B1H, B1H, CXY02, DD, BPM, QD, DD, B1H,
...
ring_no_sd_qs_ = [deepcopy(x) for x in ring_no_sd_qs]




ring_all_= [B1H, CXY01, DD, BPM, QF,SF,QS, DD, B1H, B1H, CXY02, DD, BPM, QD, DD, B1H,
...
ring_all = [deepcopy(x) for x in ring_all_]


ring_all__nos= [B1H, CXY01, DD, BPM, QF,QS, DD, B1H, B1H, CXY02, DD, BPM, QD, DD, B1H,
...
ring_all_nos = [deepcopy(x) for x in ring_all__nos]