...
def getOrm_AT_x(self):
    ...
    for j in range(len(self.indexes)):
        ...
        for i in indx:
            file = open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_"+str(i[0])+str(i[1])+".txt", "a")
    ...
    f = open("C:/Users/musa/pyat-loco-1/fodo_loco/mydata/orm_X/orm_x_CXY_" + str(i[0]) + str(i[1]) + ".txt", "a+")
